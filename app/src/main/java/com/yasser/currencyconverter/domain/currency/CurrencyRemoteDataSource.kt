...
interface CurrencyRemoteDataSource {
    suspend fun getHistoricalCurrency(date:String): BaseResult<HashMap<String, Double>, ApiError>
    suspend fun getLatestCurrency(): BaseResult<HashMap<String, Double>, ApiError>
    suspend fun getCurrencySymbols(): BaseResult<HashMap<String, String>, ApiError>
}